...
<
<body style="background-image:url(image/pict.jpg); background-size:cover; background-attachment: fixed;">
    <div class="login-box">
        <div class="login-box-body">

            <div class="login-logo">
                <img src="image/logo.png" alt="" width="45%"><br>
                <a href="#"><b>Ujian Online</b><br>SDN 1 BLATER</a>
            </div><!-- /.login-logo -->
