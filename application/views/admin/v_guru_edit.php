        ...
        <div class="box box-success" style="overflow-x: scroll;">
            ...
            <form action="<?=base_url('guru/update');?>" method="post" class="form-horizontal">
              <div class="box-body">
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label">NIP (Nomor Induk Pegawai)</label>
                  <div class="col-sm-10">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="alamat" value="<?= $a->alamat;?>" required>
                  </div>
                </div>
                      <div class="form-group">
                  <label class="col-sm-2 control-label">Jenis Kelamin</label>
                  <div class="col-sm-10">
                   <select name="jenis_kelamin" id="" class="form-control" value="<?= $ds->jenis_kelamin; ?>">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="telp" value="<?= $a->telp;?>" required>
                  </div>
                  </div>
