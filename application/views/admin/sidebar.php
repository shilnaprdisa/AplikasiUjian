    ...
    <section class="sidebar">
      ...
      <?php if ($this->session->userdata('status') == 'admin_login') { ?>
            ...
            <li <?= $this->uri->segment(1) == 'guru' ? 'class="active"' : '' ?>>
              <a href="<?php echo base_url('guru'); ?>"><i class="fa fa-user-plus"></i> Data Guru</a>
            </li>
            <li <?= $this->uri->segment(1) == 'siswa' ? 'class="active"' : '' ?>>
              <a href="<?php echo base_url('siswa'); ?>"><i class="fa fa-users"></i> Data Siswa</a>
            </li>
            <li <?= $this->uri->segment(1) == 'soal_ujian' ? 'class="active"' : '' ?>>
              <a href="<?php echo base_url('soal_ujian'); ?>"><i class="fa fa-folder"></i> Kelola Soal Ujian</a>
            </li>
             <li <?= $this->uri->segment(1) == 'peserta' ? 'class="active"' : '' ?>>
              <a href="<?php echo base_url('peserta'); ?>"><i class="fa fa-database"></i> Kelola Peserta Ujian</a>
            </li>
            <li <?= $this->uri->segment(1) == 'hasil_ujian' ? 'class="active"' : '' ?>>
              <a href="<?php echo base_url('hasil_ujian'); ?>"><i class="fa fa-book"></i> Hasil Ujian</a>
            </li>
            <!--<li <?= $this->uri->segment(1) == 'video' ? 'class="active"' : '' ?>>
              <a href="<?php echo base_url('video'); ?>"><i class="fa fa-gears"></i>
